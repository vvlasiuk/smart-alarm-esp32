/*
  РОЗУМНИЙ ІНДИКАТОР ТРИВОГИ + БУДИЛЬНИКИ — ESP32, версія 13
  ---------------------------------------------------------------------------
  Ця версія ЗАМІНЮЄ всі попередні файли. Зміни порівняно з v12:

  1) ГОЛОВНЕ: нічний режим для LED. Пристрій часто стоїть у спальні
